...
module.exports = { isValid,isValidRequestBody,isValidTitle,isValidObjectId,validString,validInstallment,validatingInvalidObjectId,validQuantity,isValidStatus }